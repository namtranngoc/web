...
// --- 1. TẠO COMPONENT CON CHỨA LOGIC ---
function PostsList() {
...
// --- 2. COMPONENT CHÍNH (PAGE) ---
export default function PostsPage() {
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: '"Times New Roman", Times, serif' }}>
      <div className="h-28"></div>
      
      {/* QUAN TRỌNG: Bọc component con trong Suspense */}
      <Suspense fallback={<div className="py-40 text-center font-bold">Đang chuẩn bị dữ liệu tìm kiếm...</div>}>
        <PostsList />
      </Suspense>
